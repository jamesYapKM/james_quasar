    ...
    <div class="layout-padding" style="max-width: 1400px;">
      ...
      >
        <q-tr slot="body" slot-scope="props" :props="props">
          <q-td key="desc" :props="props" class="bg-grey">
            {{ props.row.name }}
            <q-popover>
      ...
      >
        <q-tr slot="header" slot-scope="props">
          <q-th auto-width>
            <q-checkbox @input="logMessage(props)" v-if="props.multipleSelect" v-model="props.selected" :indeterminate="props.partialSelected" :color="color" />
          </q-th>
          <q-th v-for="col in props.cols" :key="col.name" :props="props">
            @ {{col.label}}
          </q-th>
        ...
        <template slot="body" slot-scope="props">
          <q-tr :props="props">
            <q-td auto-width>
              <q-checkbox @input="logMessage(props)"  :color="color" v-model="props.selected" />
            </q-td>
      ...
      >
        <q-tr slot="header" slot-scope="props">
          <q-th auto-width>
            <q-checkbox @click.native="clickRow(props)" v-if="props.multipleSelect" v-model="props.selected" :indeterminate="props.partialSelected" :color="color" />
          </q-th>
          <q-th v-for="col in props.cols" :key="col.name" :props="props">
            @ {{col.label}}
          </q-th>
        ...
        <q-tr slot="body" slot-scope="props" :key="props.key" :props="props">
          <q-td auto-width>
            <q-checkbox :color="color" @click.native="clickRow(props)"  v-model="props.selected" />
          </q-td>
          <q-td v-for="col in props.cols" :key="col.name" :props="props">
            ^{{ col.value }}
          </q-td>
