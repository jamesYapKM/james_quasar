<template>
  <div>
    <div class="layout-padding">
      ...
      <q-datetime-picker :interval="5" v-model="model" type="time" />

      <q-datetime v-model="model" :interval="5"  type="datetime" />
      <div class="bg-black q-pa-md">
        <q-datetime dark v-model="model" type="datetime"  :interval="5"/>
        <q-datetime-picker  :interval="5" class="q-my-md" dark v-model="model" type="datetime" />
        <q-datetime-picker  :interval="5" class="q-my-md" dark color="primary" v-model="model" type="datetime" />
      ...
      <p class="caption">Time 24hr Format (force)</p>
      <q-datetime-picker  :interval="5"  v-model="model" type="time" format24h />
