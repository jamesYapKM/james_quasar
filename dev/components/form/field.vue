  ...
  <div>
    <div class="layout-padding" style="max-width: 600px; border: 1px solid black;">
      ...
      <q-field
        ...
        helper="Helper"
        label="Horizontal"
        error-label="Max 10 <br/> characters!"
      >
        <q-option-group
          dark
          type="radio"
      ...
      <q-field icon="cloud" :error="error" :warning="warning" label="Field label" helper="Field helper text" error-label="Field error:<br/> label" :label-width="3">
