  ...
  methods: {
    ...
    __getBottomContent (h) {
      ...
      if (this.hasError && (label = this.$slots['error-label'] || this.errorLabel)) {
        return h('div', {staticClass: 'q-field-error col', domProps: {innerHTML: label}})
      }
      if (this.hasWarning && (label = this.$slots['warning-label'] || this.warningLabel)) {
        return h('div', {staticClass: 'q-field-warning col', domProps: {innerHTML: label}})
      }
      if ((label = this.$slots.helper || this.helper)) {
        return h('div', {staticClass: 'q-field-helper col', domProps: {innerHTML: label}})
      }
